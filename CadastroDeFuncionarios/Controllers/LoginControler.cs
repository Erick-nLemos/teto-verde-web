...
namespace CadastroDeFuncionarios.Controllers
{
    public class LoginControler : Controller
    {
        ...
        public LoginControler(IUsuarioRepositorio usuarioRepositorio, ISessao sessao, IEmail email)
        {
        ...
        public IActionResult Sair()
        {
            ...
            return RedirectToAction("Index", "LoginControler");
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        TempData["MensagemErro"] = $"Senha do usuario é inválido(s).";
                    }
